...
class SiteCommanderController extends ControllerBase {
  ...
  public function updatePoll() {
    ...
    $uptime = SiteCommanderController::getUptime($drupalInfo['numCores']);
    $drupalInfo['uptime'] = $uptime['uptime'];
    $drupalInfo['idletime'] = $uptime['idletime'];
    $drupalInfo['idlepct'] = $uptime['idlepct'];

    $drupalInfo['loadAverage'] = SiteCommanderController::getCpuLoadAverage($drupalInfo['numCores']);
    $drupalInfo['memInfo'] = SiteCommanderController::getMemoryInfo();
    $drupalInfo['redisStats'] = SiteCommanderController::getRedisStats();
    $drupalInfo['numRedisObjectsCached'] = $drupalInfo['redisStats']['numObjectsCached'];
    $drupalInfo['opCacheStats'] = SiteCommanderController::getOpCacheStats();
    ...
    $drupalInfo['apcStats'] = SiteCommanderController::getApcStats();
    $drupalInfo['storageHealth'] = SiteCommanderController::getStorageHealth();
    ...
    $drupalInfo['usersOnline'] = SiteCommanderController::getUsersOnline();
  ...
  public function getMemoryInfo() {
    ...
    if (preg_match('/.*nux.*/', php_uname())) {
      ...
      elseif ($memInfo['MemAvailable']['value'] / $memInfo['MemTotal']['value'] <= .25) {
      ...
      elseif ($memInfo['SwapFree']['value'] / $memInfo['SwapTotal']['value'] <= .25) {
